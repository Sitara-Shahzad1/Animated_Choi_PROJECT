  ...
  return (
    <div  className='w-full p-20 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black'>
     ...
     <div className="w-full flex gap-5 border-t-[1px] mt-22 border-[#a1bb4b]">
      ...
      <div className="w-1/2 h-[60vh] bg-[#93ab3e] rounded-4xl mt-1"> <img className='rounded-3xl' src="https://ochi.design/wp-content/uploads/2022/05/Homepage-Photo-1326x939.jpg" alt="" /></div>
     </div>
    </div>
  )
}
