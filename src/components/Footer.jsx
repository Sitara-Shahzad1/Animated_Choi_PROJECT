...
const Footer = () => {
  return (
    <div  className='w-full h-screen bg-zinc-900 flex  '>
      <div className="w-1/2  p-20 pb-0 h-[96vh] flex flex-col justify-between ">
      <div className="heading ">

      <h1 className='text-[6vw]  uppercase font-bold leading-tight  '>Eye-</h1>
      <h1 className='text-[6vw] uppercase font-bold leading-none '>Opening</h1>
      </div>
      <svg width="100" height="100" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-1/2  py-20 pb-10  h-[96vh] flex flex-col ">
        <div className="heading">

      <h1 className='text-[6vw]  uppercase font-bold leading-none  '>Presntation</h1>
    
      </div>
      <div className="footer-link-container  flex flex-col gap-15 py-20">
        <div className="footer-links flex flex-col gap-5 text-2xl">
          <div className="link-heading text-3xl">S:</div>
        ...
        <div className="footer_mid_links flex justify-between px-0.5">
          <div className="footer-links flex flex-col gap-5 text-2xl">
          <div className="link-heading text-3xl">L:</div>
          <div className="links flex flex-col gap-2">
            <a className="underline">202-1965 W 4th Ave</a>
            <a className="underline mb-10">Vancouver, Canada</a>
            <a className="underline">30 Chukarina St</a>
            <a className="underline">Lviv, Ukraine</a>
          </div>
        </div>
          <div className="footer-links flex flex-col gap-5 text-2xl pr-30">
          <div className="link-heading text-3xl ">M:</div>
          <div className="links flex flex-col gap-2">
            <a className="underline">Home</a>
            <a className="underline ">Services</a>
            <a className="underline">Our work</a>
            <a className="underline">About us</a>
            <a className="underline">Insights</a>
            <a className="underline">Contact us</a>
          </div>
        </div>
        </div>
        <div className="footer_end_links">
           <div className="footer-links flex flex-col gap-0 text-2xl">
          <div className="link-heading text-3xl">E:</div>
          <div className="links flex flex-col gap-2">
            <a className="underline">hello@ochi.design</a>
      ...
      <div className="copyright-section flex justify-between  ">
        <a href="" className='text-2xl pr-20 text-[#807e7e]'>
								© ochi design 2025. <span className='underline'>Legal Terms
                  </span>  </a>
        <a href="" className='text-2xl pr-20 text-[#807e7e]'>Website by Obys</a>
      </div>
      </div>
    </div>
  )
